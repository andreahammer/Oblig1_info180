...
from max_dim_h import ZeroH3
from pythagoras_h import Pythagoras_h
...
if __name__ == '__main__':
    ...
    sa = GridWalkSpace(LifoQueue())
    sb = GridWalkSpace(PriorityQueue())
    sp.solve()
    print("")
    print("Djupn-først")
    sa.solve()
    ...
    print("")
    print ("Oppgave 3")
    sc = GridWalkSpace(PriorityQueue(), ZeroH())
    sc.solve()
    print ("")
    print ("Oppgave 4")
    sd = GridWalkSpace(PriorityQueue(), Pythagoras_h())
    sd.solve()
    print ("")
    print ("Oppgave 5")
    se = GridWalkSpace(PriorityQueue(), ZeroH3())
    se.solve()
